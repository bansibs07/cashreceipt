		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#bcbsmncomcashreceipt-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"bcbsmncomcashreceipt-display": {
								"semanticObject": "bcbsmncomcashreceipt",
								"action": "display",
								"description": "Cash Receipt Application",
								"title": "Cash Receipt Application",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=bcbsmn.com.cashreceipt",
									"url": sap.ui.require.toUrl("bcbsmn/com/cashreceipt")
								}
							}
						}
					}
